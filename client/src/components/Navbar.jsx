  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-200 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center gap-6 text-[15px]">
            ...
            {token ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-2 rounded-xl transition shadow-sm font-medium"
                >
                  Sign Up
                </Link>
              </>
        ...
        {/* MOBILE MENU */}
        {menuOpen && (
          <div className="md:hidden pb-5 flex flex-col gap-4 animate-fade-in border-t border-gray-100 pt-4">

            {token ? (
              <>
                <Link to="/home">Home</Link>
                <Link to="/books">Explore</Link>
                <Link to="/view-posts">My Posts</Link>
